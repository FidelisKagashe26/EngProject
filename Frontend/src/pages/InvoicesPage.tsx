...
export const InvoicesPage = () => {
  ...
  const resetForm = (type: InvoiceType) => {
    setEditingId("");
    setFormType(type);
    setFormProjectId(activeProjectId || projects[0]?.id || "");
                ...
                <tbody>
                  {pagination.paginatedRows.map((invoice, index) => (
                    <tr key={invoice.id}>
                      ...
                      <td><span className="ops-cell-strong">{invoice.number}</span></td>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <label className="form-field">
                <span>Project</span>
                <GuiSelect className="input-field" onChange={(e) => setFormProjectId(e.target.value)} value={formProjectId}>
              ...
              <label className="form-field">
                ...
                <input className="input-field" onChange={(e) => setClientAddress(e.target.value)} placeholder="City / address" value={clientAddress} />
              </label>
              <label className="form-field">
                <span>Client Contact</span>
                <input className="input-field" onChange={(e) => setClientContact(e.target.value)} placeholder="Email / phone" value={clientContact} />
              </label>
              <label className="form-field">
                <span>Client TIN (Optional)</span>
                <input className="input-field" onChange={(e) => setClientTin(e.target.value)} placeholder="TIN" value={clientTin} />
              </label>
          ...
          <SurfaceCard className="my-8 w-full max-w-2xl" title={`${viewInvoice.type === "Proforma" ? "Proforma Invoice" : "Invoice"} ${viewInvoice.number}`}>
            ...
            <div className="mt-3 grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <p className="text-slate-500">{viewInvoice.clientAddress}</p>
                <p className="text-slate-500">{viewInvoice.clientContact}</p>
